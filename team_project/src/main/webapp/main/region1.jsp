...
<!-- Breadcrumb Section Begin -->
    ...
    <h3 class="search_name">제주시 펜션</h3><br>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
...
if(startPage > pageBlock){
	%>
	<a href="Region1.me?pageNum=<%=startPage-pageBlock%>">[10페이지 이전]<i class="fa fa-long-arrow-right"></i></a>
	<%
}

for(int i=startPage;i<=endPage;i++){
	%>
	<a href="Region1.me?pageNum=<%=i%>"><%=i%></a>
	<%
}
...
if(endPage < pageCount){
	%>
	<a href="Region1.me?pageNum=<%=startPage+pageBlock%>">[10페이지 다음]
