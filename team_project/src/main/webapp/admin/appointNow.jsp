...
ArrayList<AppointmentDTO> AppointmentList=dao.getAppointmentList2(startRow, pageSize);
	...
	<tr><td class="tb2">유저번호</td><td class="tb2">예약번호</td><td class="tb2">펜션이름</td><td class="tb2">예약상태</td><td class="tb2">예약상태 변경</td><td class="tb2">예약일자</td><td class="tb2">예약취소</td></tr>
	<%
